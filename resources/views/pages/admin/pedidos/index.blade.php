...
@section('navegacao')
    <form action="{{ route('index_pedido') }}" class="form form-inline ml-2" method="POST">
        ...
        <select class="form-select form-control" aria-label="Default select example" name="select">
            ...
            <option value="numero">Numero do pedido crescente</option>
            <option value="data">data do pedido crescente</option>
        </select>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('delete_pedido', $pedido->id) }}" method="POST">
                            ...
                            <a href="{{ route('update_pedido', [$pedido->id, 'Pago']) }}" class="btn btn-info">Marcar
                                como pago</a>
